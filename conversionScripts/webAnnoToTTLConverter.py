...
for tabname in tabletnames:
    ...
    for side in tabletsides:
        ...
        for key in data:
            ...
            res.write("<"+str(indid)+"> rdfs:label \"Annotation of Glyph at "+str(tabname)+" "+str(side)+" line "+str(lineindex)+" char "+str(charindex)+" on "+str(material)+"\"@en .\n")
            res.write("<"+str(indid)+"_body_glyph> rdf:type oa:SpecificResource .\n")
            res.write("<"+str(indid)+"_body_glyph> oa:hasSource <"+str(namespaceitems)+str(tabname).lower()+"_"+str(side)+"_line"+str(lineindex)+"_char"+str(charindex)+"_glyph> .\n")
            res.write("<"+str(indid)+"_body_glyph> oa:motivatedBy oa:identifying .\n")
            res.write("<"+str(indid)+"_body_glyph> rdfs:label \"Annotation body referencing Glyph at "+str(tabname)+" "+str(side)+" line "+str(lineindex)+" char "+str(charindex)+" on "+str(material)+"\"@en .\n")
            res.write("<"+str(indid)+"_body_translit> rdf:type oa:SpecificResource .\n")
            res.write("<"+str(indid)+"_body_translit> oa:hasSource <"+str(namespaceitems)+str(tabname)+"_transliteration1_"+str(side)+"_line"+str(lineindex)+"_char"+str(charindex)+"> .\n")
            ...
            res.write("<"+str(indid)+"_body_translit> rdfs:label  \"Annotation body referencing transliteration char occurrence at "+str(tabname)+" "+str(side)+" line "+str(lineindex)+" char "+str(charindex)+" on "+str(material)+"\"@en .\n")
            if key in data3d and "target" in data3d[key] and "selector" in data3d[key]["target"]:
                ...
                res.write("<"+str(indid)+"_target3d> rdfs:label \"3D Annotation target of Annotation of Glyph at "+str(tabname)+" "+str(side)+" line "+str(lineindex)+" char "+str(charindex)+" on "+str(material)+"\"@en .\n")
                ...
                res.write("<"+str(indid)+"_target3d_selector> rdfs:label \"3D Annotation target selector of Annotation of Glyph at "+str(tabname)+" "+str(side)+" line "+str(lineindex)+" char "+str(charindex)+" on "+str(material)+"\"@en .\n")
            ...
            if "/raw" in str(source):
                res.write("<"+str(indid)+"_target1> oa:hasSource <"+str(source)[0:str(source).rfind("/")].replace("https://gitlab.rlp.net/api/v4/projects/28015/repository/files/renderings%2F"+str(tabname)+"%2F","https://situx.github.io/cuneiformontology/examples/"+str(tabname).lower()+"/images/")+"> .\n")
            else:
            ...
            res.write("<"+str(indid)+"_target1> rdfs:label \"Annotation target1 of Annotation of Glyph at "+str(tabname)+" "+str(side)+" line "+str(lineindex)+" char "+str(charindex)+" on "+str(material)+"\"@en .\n")
            ...
            if withglyphs:
                res.write("<"+str(namespaceitems)+str(tabname).lower()+"_"+str(side)+"_line"+str(lineindex)+"_char"+str(charindex)+"_glyph> rdf:type <http://www.cidoc-crm.org/cidoc-crm/TX9_Glyph> .\n")
                res.write("<"+str(namespaceitems)+str(tabname).lower()+"_"+str(side)+"_line"+str(lineindex)+"_char"+str(charindex)+"_glyph> rdfs:label \"Glyph at "+str(tabname)+" "+str(side)+" side line "+str(lineindex)+" char "+str(charindex)+"\"@en . \n")
            if withcharoccs:
                res.write("<"+str(namespaceitems)+str(tabname).lower()+"_"+str(side)+"_line"+str(lineindex)+"_char"+str(charindex)+"> rdf:type cunei:TransliterationCharOccurrence .\n")
                res.write("<"+str(namespaceitems)+str(tabname).lower()+"_"+str(side)+"_line"+str(lineindex)+"_char"+str(charindex)+"> rdfs:label \"Transliteration Char Occurrence at "+str(tabname)+" "+str(side)+" side line "+str(lineindex)+" char "+str(charindex)+"\"@en .\n")
            if withlines:
                res.write("<"+str(namespaceitems)+str(tabname).lower()+"_"+str(side)+"_line"+str(lineindex)+"> rdf:type cunei:Line .\n")
                res.write("<"+str(namespaceitems)+str(tabname).lower()+"_"+str(side)+"_line"+str(lineindex)+"> rdfs:label rdfs:label \""+str(tabname)+" "+str(side)+" line "+str(lineindex)+"\"@en .\n")
        res.close()
        g = Graph()
