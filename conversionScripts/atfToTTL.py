...
for tabname in tabletnames:
    ...
    for line in atfsslines:
        if line.startswith("#") or line.startswith("$") or line.startswith("@tablet"):
            ...
            cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_"+currentsideuri+"_"+replaceNonURIChars(str(currentline))+" skos:definition \""+str(line)+"\" .\n")
            cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_"+currentsideuri+"_"+replaceNonURIChars(str(currentline))+" lemon:writtenRepUnicode \""+str(cuneifyWord(str(currentline),str(namespace)+""+str(currenttabletid)+"_"+currentsideuri+"_"+replaceNonURIChars(str(currentline))+"_"+str(currentwordindex)+"_wordformocc",cdlitabs)).replace("\"","")+"\"^^cunei:unicodeLiteral .\n")
            cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_"+currentsideuri+"_"+replaceNonURIChars(str(currentline))+" lemon:writtenRepASCII \""+str(format_ascii(str(currentline))).replace("\"","")+"\"^^cunei:ASCIILiteral .\n")
            ...
            for word in linespl:
                ...
                cdlitabs.add(str(namespaceprefix)+":"+replaceNonURIChars(str(word))+"_wordform lemon:writtenRepUnicode \""+str(cuneifyWord(str(word),str(namespace)+""+str(currenttabletid)+"_"+currentsideuri+"_"+replaceNonURIChars(str(currentline))+"_"+str(currentwordindex)+"_wordformocc",cdlitabs)).replace("\"","")+"\"^^cunei:unicodeLiteral .\n")
                ...
                for charr in wordspl:
                    ...
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_"+replaceNonURIChars(str(currentline))+"_"+str(currentcharindex)+"_charocc skos:definition \""+str(charr)+"\" .\n")
