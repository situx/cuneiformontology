...
for tabname in tabletnames:
    ...
    for line in atfsslines:
        if line.startswith("#") or line.startswith("$") or line.startswith("@tablet"):
            ...
            cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+" rdf:type cunei:TransliterationLine .\n")
            cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+" skos:definition \""+str(line)+"\" .\n")
            cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+" lemon:writtenRepUnicode \""+str(cuneifyWord(str(currentline),str(namespace)+""+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_word"+str(currentwordindex)+"_wordformocc",cdlitabs)).replace("\"","")+"\"^^cunei:unicodeLiteral .\n")
            cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+" lemon:writtenRepASCII \""+str(format_ascii(str(currentline))).replace("\"","")+"\"^^cunei:ASCIILiteral .\n")
            cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+" rdfs:label \"Line: "+str(currentline)+" ["+str(currenttabletid)+"_"+str(currentside)+"]\" .\n")
            ...
            for word in linespl:
                ...
                if currentwordindex==0:
                    currentwordindex+=1
                    continue
                cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_word"+str(currentwordindex)+"_wordformocc rdf:type cunei:WordformOccurance .\n")
                cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_word"+str(currentwordindex)+"_wordformocc rdfs:label \" WordForm Occurrence: "+str(word)+" ("+str(currenttabletid)+"["+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_word"+str(currentwordindex)+"])\" .\n")
                cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_word"+str(currentwordindex)+"_wordformocc skos:definition \""+str(word)+"\" .\n")
                ...
                cdlitabs.add(str(namespaceprefix)+":"+replaceNonURIChars(str(word))+"_wordform  cunei:isAttested "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_word"+str(currentwordindex)+"_wordformocc .\n")
                ...
                cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+" cunei:consistsOf "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_word"+str(currentwordindex)+"_wordformocc .\n")
                if currentwordindex>0 and (currentwordindex-1)>0:
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_word"+str(currentwordindex)+"_wordformocc cunei:prevWord "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_word"+str(currentwordindex-1)+"_wordformocc .\n")
                if currentwordindex<=linelen and (currentwordindex+1)<=linelen:
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_word"+str(currentwordindex)+"_wordformocc cunei:nextWord "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_word"+str(currentwordindex+1)+"_wordformocc .\n")
                currentrelcharindex=0
                ...
                for charr in wordspl:
                    if charr=="":
                        continue
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_charocc rdf:type cunei:TransliterationCharOccurrence .\n")
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_charocc rdfs:label \"Char Occurrence: "+str(charr)+" ("+str(currenttabletid)+"["+str(currentside)+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"])\" .\n")
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_charocc skos:definition \""+str(charr)+"\" .\n")
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_glyph rdf:type cidoc:TX9_Glyph .\n")
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_glyph <http://www.cidoc-crm.org/cidoc-crm/TXP8_is_component_of> cunei:"+str(currenttabletid)+"_writtenText .\n")
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_glyph rdfs:label \"Glyph at "+str(currenttabletid)+"["+str(currentside)+" "+replaceNonURIChars(str(currentline))+" "+str(currentrelcharindex)+"])\" .\n")
                    ...
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_word"+str(currentwordindex)+"_wordformocc cunei:consistsOf "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_charocc .\n")
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_charocc cunei:partOf "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_word"+str(currentwordindex)+"_wordformocc .\n")
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_charocc cunei:positionOnTabletSide \""+str(currentrelcharindex)+"\"^^xsd:integer .\n")
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_charocc cunei:positionInWord \""+str(currentrelcharindex)+"\"^^xsd:integer .\n")
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_charocc lemon:writtenRepUnicode \""+str(cuneifyWord(str(charr),str(namespace)+""+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_charocc",cdlitabs))+"\" .\n")
                    if "#" in charr:
                        cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_glyph cunei:isDamaged \"true\"^^xsd:boolean .\n")
                    else:
                        cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_glyph cunei:isDamaged \"false\"^^xsd:boolean .\n")
                    curchar={"_class":"chr","@id":str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_charocc","@type":"TransliterationCharOccurrence","reading":str(charr),"grapheme":getGraphemeReadingURI(cleanForCharLookup(str(charr)))}                            
                    curseq["children"].append(curchar)
                    if currentrelcharindex>0:
                        if (currentrelcharindex-1)>0:
                            cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_charocc cunei:prevInWord "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex-1)+"_charocc .\n")
                            cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_glyph cunei:prevInWord "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex-1)+"_glyph .\n")
                        cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_charocc cunei:prev "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex-1)+"_charocc .\n")
                        cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_glyph cunei:prev "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex-1)+"_glyph .\n")
                    if currentrelcharindex<=wordspllen and (currentrelcharindex+1)<=wordspllen:
                        cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_charocc cunei:nextInWord "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_transliteration1_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex+1)+"_charocc .\n")
                        cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex)+"_glyph cunei:nextInWord "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentrelcharindex+1)+"_glyph .\n")
