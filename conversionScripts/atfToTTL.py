    ...
    if word!="" and word!="," and word.lower() in cuneify:
        ...
        for chara in unicodeword:
            if chara in signmapping:
                ...
                ttlresult.add("<"+str(signmapping[chara]["@id"].replace("http://purl.org/cuneiform/signlist/","https://situx.github.io/cuneiformontology/signlist/"))+"_variant1> rdf:type graphemon:GraphemeVariant . \n")
                ttlresult.add("<"+str(signmapping[chara]["@id"].replace("http://purl.org/cuneiform/signlist/","https://situx.github.io/cuneiformontology/signlist/"))+"> rdfs:label \"Character: "+str(signmapping[chara]["signname"])+"\"@en . \n")
                ttlresult.add("<"+str(signmapping[chara]["@id"].replace("http://purl.org/cuneiform/signlist/","https://situx.github.io/cuneiformontology/signlist/"))+"> graphemon:variant <"+str(signmapping[chara]["@id"].replace("http://purl.org/cuneiform/signlist/","https://situx.github.io/cuneiformontology/signlist/"))+"_variant1> .\n")
                ttlresult.add("<"+str(signmapping[chara]["@id"].replace("http://purl.org/cuneiform/signlist/","https://situx.github.io/cuneiformontology/signlist/"))+"_variant1> rdfs:label \"Grapheme "+str(signmapping[chara]["signname"])+": Variant 1\"@en . \n")
            ...
            if counter<len(chars) and chara in signmapping:
                ...
                ttlresult.add("<"+str(signmapping[chara]["@id"].replace("http://purl.org/cuneiform/signlist/","https://situx.github.io/cuneiformontology/signlist/"))+"_reading_"+str(chars[counter])+"> rdfs:label \"Grapheme Reading "+str(signmapping[chara]["signname"])+": "+str(chars[counter])+"\"@en .\n")
...
def imageURLEscape(url):
    return url.replace("#","%23").replace("{","%7B").replace("}","%7D").replace("?","%3F").replace("[","%5B").replace("]","%5D")
...
for tabname in tabletnames:
    ...
    cdlitabs.add("cidoc:E22_ManMadeObject rdfs:label \"Man made object\"@en  .\n")
    cdlitabs.add("cunei:Transliteration rdfs:subClassOf prov:Entity .\n")
    cdlitabs.add("cunei:Transliteration rdfs:label \"transliteration\"@en .\n")
    cdlitabs.add("cunei:Tablet rdfs:subClassOf cidoc:E22_ManMadeObject .\n")
    cdlitabs.add("cunei:Tablet rdfs:label \"cuneiform tablet\"@en .\n")
    ...
    cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_transliteration1_lexicon_sux rdf:type lemon:Lexicon .\n")
    cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_transliteration1_lexicon_sux rdfs:label \"Sumerian Lexicon for "+str(currenttabletid)+" generated from transliteration 1\"@en .\n")
    cdlitabs.add("graphemon:GraphemeCollection rdfs:subClassOf skos:Collection .\n")
    cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_signlist rdf:type graphemon:GraphemeCollection .\n")
    cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_signlist rdfs:label \"Signlist of "+str(currenttabletid)+"\"@en .\n")
    cdlitabs.add("graphemon:GraphemeReadingCollection rdfs:subClassOf skos:Collection .\n")
    cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_signreadinglist rdf:type graphemon:GraphemeReadingCollection .\n")
    ...
    cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_graphemevars rdf:type graphemon:GraphemeVariantCollection .\n")
    cdlitabs.add("graphemon:GraphemeVariantCollection rdfs:subClassOf skos:Collection .\n")
    ...
    for line in atfsslines:
        if line.startswith("#") or line.startswith("$") or line.startswith("@tablet"):
            ...
            cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_transliteration1_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+" rdfs:label \"Transliteration Line: "+str(currentline)+" ["+str(currenttabletid)+"_"+str(currentside)+"]\"@en .\n")
            ...
            for word in linespl:
                ...
                cdlitabs.add(namespaceprefix+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_word foaf:image \""+imageURLEscape(str(namespace)+"images/word/word_"+replaceNonURIChars(str(currentline))+"_"+str(currentwordindex)+"_"+str(tabname)+"_"+str(tabsideid[currentside])+"_"+str(currentside).replace("obverse","front").replace("reverse","back"))+".jpg\"^^xsd:anyURI .\n")
                if createRefLinks:
                ...
                wordformresult.add(str(namespaceprefix)+":"+replaceNonURIChars(str(word))+"_wordform rdfs:label \"WordForm: "+replaceNonURIChars(str(word)).replace("\"","")+"\"@en .\n")
                cdlitabs.add(str(namespaceprefix)+":"+replaceNonURIChars(str(word))+"_wordform rdfs:label \"WordForm: "+str(word).replace("\"","")+"\"@en .\n")
                ...
                for charr in wordspl:
                    ...
                    if tabname in renderingvars:
                        for item in renderingvars[tabname]:
                            cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentcharindex)+"_glyph foaf:image \""+imageURLEscape(str(namespace)+"images/charline/charline_"+replaceNonURIChars(str(currentline))+"_"+str(currentcharindex)+"_"+str(charr)+"_"+str(tabname)+"_"+str(item)+"_"+str(currentside).replace("obverse","front").replace("reverse","back"))+".jpg\"^^xsd:anyURI .\n")
                            cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentcharindex)+"_glyph foaf:image \""+imageURLEscape(str(namespace)+"images/character/char_"+replaceNonURIChars(str(currentline))+"_"+str(currentcharindex)+"_"+str(charr)+"_"+str(tabname)+"_"+str(item)+"_"+str(currentside).replace("obverse","front").replace("reverse","back"))+".jpg\"^^xsd:anyURI .\n")                
                    else:
                        if tabname in withid:
                            cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentcharindex)+"_glyph foaf:image \""+imageURLEscape(str(namespace)+"images/charline/charline_"+replaceNonURIChars(str(currentline))+"_"+str(currentcharindex)+"_"+str(charr)+"_"+str(tabname)+"_"+str(tabsideid[currentside])+"_"+str(currentside).replace("obverse","front").replace("reverse","back"))+".jpg\"^^xsd:anyURI .\n")
                            cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentcharindex)+"_glyph foaf:image \""+imageURLEscape(str(namespace)+"images/character/char_"+replaceNonURIChars(str(currentline))+"_"+str(currentcharindex)+"_"+str(charr)+"_"+str(tabname)+"_"+str(tabsideid[currentside])+"_"+str(currentside).replace("obverse","front").replace("reverse","back"))+".jpg\"^^xsd:anyURI .\n")              
                        else:
                            cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentcharindex)+"_glyph foaf:image \""+imageURLEscape(str(namespace)+"images/charline/charline_"+replaceNonURIChars(str(currentline))+"_"+str(currentcharindex)+"_"+str(charr)+"_"+str(tabname)+"_"+str(currentside).replace("obverse","front").replace("reverse","back"))+".jpg\"^^xsd:anyURI .\n")
                            cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentcharindex)+"_glyph foaf:image \""+imageURLEscape(str(namespace)+"images/character/char_"+replaceNonURIChars(str(currentline))+"_"+str(currentcharindex)+"_"+str(charr)+"_"+str(tabname)+"_"+str(currentside).replace("obverse","front").replace("reverse","back"))+".jpg\"^^xsd:anyURI .\n")      
                    ...
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentcharindex)+"_glyph rdfs:label \"Glyph at "+str(currenttabletid)+"["+str(currentside)+" "+replaceNonURIChars(str(currentline))+" "+str(currentcharindex)+"])\"@en .\n")
                    ...
                    if currentcharindex>0 and (currentcharindex-1)>0:
                        ...
                        cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentcharindex)+"_glyph graphemon:prevGlyph "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentcharindex-1)+"_glyph .\n")
                    if currentcharindex<=wordspllen and (currentcharindex+1)<=wordspllen:
                        ...
                        cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentcharindex)+"_glyph graphemon:nextGlyph "+str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentcharindex+1)+"_glyph .\n")
                    currentrelcharindex+=1
                    currentcharindex+=1
                    globalcharindex+=1
                currentwordindex+=1
