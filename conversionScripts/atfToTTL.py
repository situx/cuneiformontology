        ...
        if line.startswith("#") or line.startswith("$") or line.startswith("@tablet"):
            ...
            for word in linespl:
                ...
                for charr in wordspl:
                    ...
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentcharindex)+"_glyph foaf:image \""+str(namespace)+"images/charline/charline_"+replaceNonURIChars(str(currentline))+"_"+str(currentcharindex)+"_"+str(tabname)+"_"+str(tabsideid[currentside])+"_"+str(currentside).replace("obverse","front").replace("reverse","back")+".jpg\"^^xsd:anyURI .\n")
                    cdlitabs.add(str(namespaceprefix)+":"+str(currenttabletid)+"_"+currentsideuri+"_line"+replaceNonURIChars(str(currentline))+"_char"+str(currentcharindex)+"_glyph foaf:image \""+str(namespace)+"images/character/char_"+replaceNonURIChars(str(currentline))+"_"+str(currentcharindex)+"_"+str(tabname)+"_"+str(tabsideid[currentside])+"_"+str(currentside).replace("obverse","front").replace("reverse","back")+".jpg\"^^xsd:anyURI .\n")              
